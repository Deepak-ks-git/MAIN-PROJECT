...
class COMPLETED_DETAILS extends StatefulWidget {
  ...
  COMPLETED_DETAILS({required this.procId});

  @override
  _ProcurementDetailsPageState createState() => _ProcurementDetailsPageState();
}

class _ProcurementDetailsPageState extends State<COMPLETED_DETAILS> {
...
void main() {
  runApp(MaterialApp(
    home: COMPLETED_DETAILS(procId: 'YourProcurementId'),
  ));
}
