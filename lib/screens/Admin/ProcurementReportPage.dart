...
class ProcurementReportPage extends StatefulWidget {
  @override
  _ProcurementReportPageState createState() => _ProcurementReportPageState();
}
...
class _ProcurementReportPageState extends State<ProcurementReportPage> {
  ...
  void _downloadReport() async {
    String url = 'http://192.168.1.143:3000/api/generate-procurement-report-pdf?status=$_selectedStatus&dateRange=$_selectedDateRange';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Procurement Report', style: TextStyle(color: Colors.white,fontSize: 18)),
        ...
        child: Column(
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              ...
              items: <String>['ALL', 'CREATED', 'STARTED', 'COMPLETED'] // Added 'ALL' option
