...
class SupplierReport extends StatefulWidget {
  @override
  _SupplierReportState createState() => _SupplierReportState();
}
...
class _SupplierReportState extends State<SupplierReport> {
  ...
  void _downloadReport() async {
    String url = 'http://192.168.1.143:3000/api/Supplier-Report-PDF?status=$_selectedStatus&dateRange=$_selectedDateRange';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Supplier Report', style: TextStyle(color: Colors.white,fontSize: 18)),
        ...
        child: Column(
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              ...
              items: <String>['ALL','Active','Inactive','Blacklisted'] // Added 'ALL' option
            ...
            Row(
              children: [
                Text('Date Joined:', style: TextStyle(fontSize: 16)),
                SizedBox(width: 8),
                Container(
