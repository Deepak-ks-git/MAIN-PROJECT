...
class New_Order_Details extends StatefulWidget {
  final String procId;
  final String purchaseReqId;

  const New_Order_Details({Key? key, required this.procId, required this.purchaseReqId})
      : super(key: key);

  @override
  _New_Order_DetailsState createState() => _New_Order_DetailsState();
}

class _New_Order_DetailsState extends State<New_Order_Details> {
  List<dynamic> items = [];
