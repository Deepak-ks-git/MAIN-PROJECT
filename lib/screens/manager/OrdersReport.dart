...
class OrdersReport extends StatefulWidget {
  @override
  _OrdersReportState createState() => _OrdersReportState();
}
...
class _OrdersReportState extends State<OrdersReport> {
  ...
  void _downloadReport() async {
    String url = 'http://192.168.1.143:3000/api/Orders-Report-PDF?status=$_selectedStatus&dateRange=$_selectedDateRange';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Orders Report', style: TextStyle(color: Colors.white,fontSize: 18)),
        ...
        child: Column(
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              ...
              items: <String>['ALL','PLACED','PROCESSING','PROCESSED','SHIPPED','DELIVERED','COMPLETED'] // Added 'ALL' option
