...
class PurchaseRequestReport extends StatefulWidget {
  @override
  _PurchaseRequestReportState createState() => _PurchaseRequestReportState();
}

class _PurchaseRequestReportState extends State<PurchaseRequestReport> {
  ...
  void _downloadReport() async {
    String url = 'http://192.168.1.143:3000/api/REQUEST-report-pdf?status=$_selectedStatus&dateRange=$_selectedDateRange';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('PurchaseRequest Report', style: TextStyle(color: Colors.white,fontSize: 18)),
        ...
        child: Column(
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              ...
              items: <String>['ALL','READY','STARTED','ACCEPTED','REJECTED'] // Added 'ALL' option
