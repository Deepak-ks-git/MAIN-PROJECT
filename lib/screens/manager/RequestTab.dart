  ...
  Future<List<dynamic>> fetchPurchaseRequestDetails() async {
    try {
      final response = await http.get(Uri.parse(
          'http://192.168.1.143:3000/reqdetails_for_sending?procId=${widget.procId}'));
  ...
  Future<void> removeSupplier(String procId) async {
    try {
      final response = await http.post(
        Uri.parse('http://192.168.1.143:3000/drop_selected_supplier'),
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            ...
                                            Text('  Supplier Details',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16),),
                                          ],
                                        ),
                                        const SizedBox(
                                          height: 10,
                                        ...
                                        Divider(),
                                         Text('$firstName $lastName',style: TextStyle(fontWeight: FontWeight.w500,fontSize: 16),),
                                        const SizedBox(
                                          height: 5,
                                        ),
                                        Text('ID: $supplierId',style: TextStyle(fontWeight: FontWeight.w500)),
                                        const SizedBox(
                                          height: 5,
                                        ),
                                                        ...
                                                        onPressed: () async {
                                                          ...
                                                          try {
                                                            final response =
                                                                await http.post(
                                                              Uri.parse(
                                                                  'http://192.168.1.143:3000/insert_and_update_purchase_request_detail'),
                                                              body: jsonEncode({
                                                                'PURCH_REQ_ID':
                                                                    purchaseReqId,
                                                                'procId': widget
